    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="javascript:;" class="tip-bottom">菜单管理</a> <a href="#" class="current">菜单列表</a> </div>
            ...
            <div id="org"></div> 
                    ...
                    <form id="question-form" class="form-horizontal" action="<?php echo ($col_from_url); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-xs-12">                                            
                            <input name="name" type="text" class="form-control" value="<?php echo ($question["name"]); ?>" />
                        </div>
                    </div>
                    <?php if($property_name != null): ?><div class="form-group">
                         <label class="col-md-1 col-xs-12 control-label">选项填写规范</label>
                         <div class="col-md-6 col-xs-12">
                             <p style="red">
                                <h5>
                                    A选项名称<span style="color:red">*<?php echo ($property_name); ?></span>
                                </h5>
                             </p>
                         </div>
                        ...
                        <div class="col-md-7 col-xs-12 option-list">
                            <?php if(is_array($optionsList)): $i = 0; $__LIST__ = $optionsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; switch($item["type"]): case "radio": ?><div class="option-item radio_option">
                                    ...
                                    <?php case "text": ?><div class="option-item text_option">
                                            <textarea class="form-control"><?php echo ($standardList); ?></textarea>
                                            <img class="option-del" src="/Public/Images/btn-del.png" title="删除该选项">
                                        </div><?php break;?>
