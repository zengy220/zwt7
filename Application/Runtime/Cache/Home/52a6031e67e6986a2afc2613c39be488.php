...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span11">
                <form id="myform" method="post" action="/<?php echo (MODULE_NAME); ?>/Questionsearch/answer">
                    ...
                    <span class="btn btn-success">问卷查询</span>
                    ...
                    <div class="widget-content ">
                        <table class="table table-bordered table-striped with-check">
                            ...
                            <?php if(is_array($collist)): $i = 0; $__LIST__ = $collist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?><tr>
                                    <td><?php echo ($i); ?></td>
                                    <td><?php echo ($vs["question_name"]); ?></td>
                                    <?php if($vs["question_type"] == 1): ?><td><?php echo ($vs["option_name"]); ?></td><?php endif; ?>
                                    <?php if($vs["question_type"] == 3): ?><td><?php echo ($vs["content"]); ?></td><?php endif; ?>
