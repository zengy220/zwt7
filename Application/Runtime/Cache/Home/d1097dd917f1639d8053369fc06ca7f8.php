...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span11"><a href="/<?php echo (MODULE_NAME); ?>/Questionsearch/questionnaire_add_index/" class="btn btn-success btn" style="float: right;">新增问卷</a>
                    ...
                    <div class="widget-content ">
                        <table class="table table-bordered table-striped with-check">
                            ...
                            <?php if(is_array($collist)): $i = 0; $__LIST__ = $collist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?><tr>
                                   ...
                                   <td><a href="/web/index/start/questionnaire_id/<?php echo ($vs["id"]); ?>" target="view_window"><?php echo ($www); ?>/web/index/start/questionnaire_id/<?php echo ($vs["id"]); ?></a>
                                    </td>
                                    <td>
                                        <a href="/<?php echo (MODULE_NAME); ?>/Questionsearch/questionnaire_edit_index/u/<?php echo ($vs["id"]); ?>/o/edit/" class="btn btn-primary btn-mini">修改</a> |
                                        <a href="/<?php echo (MODULE_NAME); ?>/Questionsearch/question/questionnaire_id/<?php echo ($vs["id"]); ?>" class="btn btn-primary btn-mini">问题列表</a> |
                                        <a href="/<?php echo (MODULE_NAME); ?>/Questionsearch/questionnaire_add_index/u/<?php echo ($vs["id"]); ?>/o/del/" class="btn btn-danger btn-mini" onclick= "if(confirm('是否确定删除<?php echo ($vs["name"]); ?>!')==false)return  false; ">删除</a>
