                    ...
                    <div class="widget-content nopadding">
                        <form action="<?php echo ($col_from_url); ?>" method="post" class="form-horizontal" onsubmit="return check();"  enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php if(is_array($property)): foreach($property as $key=>$vo): ?><input type="text" readonly="readonly" class="span11" style="width:220px; " value="<?php echo ($vo["questions"]); ?>" name="<?php echo ($vo["id"]); ?>"><?php endforeach; endif; ?>
                                </div>
                            </div>
