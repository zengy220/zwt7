			 ...
			 $('#addquerstions').change(function() {
		            ...
		            switch (index) {
		                ...
		                case "2": //问答
		                    ...
		                    wjdc_list = $(wjdc_list).append(' <li><div class="tm_btitlt"><i class="nmb">' + Grade + '</i>. <i class="btwenzi" name="question_name[]">请编辑问题？</i><span class="tip_wz">' + danxuan + '</span></div></li>');
		                    if (index == "2") {
